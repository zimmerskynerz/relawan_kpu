                        ...
                        <?php if ($aktivitas != 'limit') : ?>
                            ...
                            <li class="menu single-menu <?php echo $this->uri->segment(2) == 'bank_soal' ? 'active' : '' ?>">
                                <a href="<?= base_url('staff/bank_soal') ?>">
                                    <div class="">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file-text shadow-icons">
                                            <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path>
                                            <polyline points="14 2 14 8 20 8"></polyline>
                                            <line x1="16" y1="13" x2="8" y2="13"></line>
                                            <line x1="16" y1="17" x2="8" y2="17"></line>
                            ...
                            <li class="menu single-menu <?php echo $this->uri->segment(2) == 'laporan' ? 'active' : '' ?>">
                                ...
                                <ul class="collapse submenu list-unstyled animated fadeInUp" id="laporan" data-parent="#topAccordion">
                                    <li>
                                        <a href="component_tabs.html"> Laporan Tugas </a>
                                    </li>
                                    <li>
                                        <a href="component_accordion.html"> Laporan Gaji </a>
                                    </li>
                                    <li>
                                        <a href="component_modal.html"> Sertifikat </a>
                                    </li>
                                </ul>
                            </li>
                        <?php endif; ?>
