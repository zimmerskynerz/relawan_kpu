            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <?= $this->session->flashdata('email_ada'); ?>
                        ...
                        <div class="text-left">
                            ...
                            <div id="email-field" class="field-wrapper input">
                                ...
                                <input required id="email" name="email" type="email" value="" class="form-control" required placeholder="Email">
                            </div>
                            <div id="ttl-field" class="field-wrapper input">
                                ...
                                <input required id="tgl_lahir" name="tgl_lahir" type="date" value="" class="form-control" required placeholder="Tanggal Lahir">
                            </div>
                            <div id="password-field" class="field-wrapper input mb-2">
                                ...
                                <input required id="password" name="password" type="password" class="form-control" required placeholder="Password">
