                                    ...
                                    foreach ($data_bank as $Data_bank) : ?>
                                        <tr>
                                            ...
                                            <td style="text-align: center;">
                                                <?php
                                                if ($Data_bank->status_soal == 'AKTIF') : ?>
                                                    <a id="detail_bank_soal" href="javascript:void(0);" class="bs-tooltip" data-toggle="modal" data-target="#bank_soal_detail" data-placement="top" title="" data-original-title="Ubah" 
                                                    data-id_ujian="<?= $Data_bank->id_ujian ?>" 
                                                    data-tahun="<?= $Data_bank->tahun ?>" 
                                                    data-jml_soal="<?= $Data_bank->jml_soal ?>">
