                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="td-content customer-name"><img src="<?= base_url('assets/') ?>img/profile-7.jpeg" alt="avatar">Andy King</div>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="td-content customer-name"><img src="<?= base_url('assets/') ?>img/profile-4.jpeg" alt="avatar">Irene Collins</div>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="td-content customer-name"><img src="<?= base_url('assets/') ?>img/profile-10.jpeg" alt="avatar">Laurie Fox</div>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="td-content customer-name"><img src="<?= base_url('assets/') ?>img/profile-13.jpeg" alt="avatar">Luke Ivory</div>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="td-content customer-name"><img src="<?= base_url('assets/') ?>img/profile-5.jpeg" alt="avatar">Ryan Collins</div>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="td-content customer-name"><img src="<?= base_url('assets/') ?>img/profile-6.jpeg" alt="avatar">Nia Hillyer</div>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="td-content customer-name"><img src="<?= base_url('assets/') ?>img/profile-11.jpeg" alt="avatar">Sonia Shaw</div>
                                        </td>
                                        <td>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="td-content product-name"><img src="<?= base_url('assets/') ?>img/speaker.jpg" alt="product">Speakers</div>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="td-content product-name"><img src="<?= base_url('assets/') ?>img/sunglass.jpg" alt="product">Sunglasses</div>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="td-content product-name"><img src="<?= base_url('assets/') ?>img/watch.jpg" alt="product">Watch</div>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="td-content product-name"><img src="<?= base_url('assets/') ?>img/laptop.jpg" alt="product">Laptop</div>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="td-content product-name"><img src="<?= base_url('assets/') ?>img/camera.jpg" alt="product">Camera</div>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="td-content product-name"><img src="<?= base_url('assets/') ?>img/shoes.jpg" alt="product">Shoes</div>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="td-content product-name"><img src="<?= base_url('assets/') ?>img/headphones.jpg" alt="product">Headphone</div>
                                        </td>
                                        <td>
