<div class="header-container">
    <header class="header navbar navbar-expand-sm">
        ...
        <div class="nav-logo align-self-center">
            <a class="navbar-brand" href="<?= base_url('staff') ?>"> <span class="navbar-brand-name">KPU KUDUS</span></a>
        </div>
                ...
                <nav id="topbar">
                    ...
                    <ul class="list-unstyled menu-categories" id="topAccordion">
                        ...
                        <li class="menu single-menu <?php echo $this->uri->segment(2) == 'pengguna' ? 'active' : '' ?>">
                            <a href="<?= base_url('staff/pengguna') ?>">
                                <div class="">
                        ...
                        <li class="menu single-menu <?php echo $this->uri->segment(2) == 'relawan' ? 'active' : '' ?>">
                            <a href="#components" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                                <div class="">
                                    ...
                                    </svg><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users shadow-icons">
                                        <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path>
                                        <circle cx="9" cy="7" r="4"></circle>
                                        <path d="M23 21v-2a4 4 0 0 0-3-3.87"></path>
                                        <path d="M16 3.13a4 4 0 0 1 0 7.75"></path>
                        ...
                        <li class="menu single-menu <?php echo $this->uri->segment(2) == 'bank_soal' ? 'active' : '' ?>">
                            <a href="<?= base_url('staff/bank_soal') ?>">
                                <div class="">
                                    ...
                                    </svg><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-book-open shadow-icons">
                                        <path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"></path>
                                        <path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"></path>
                                    </svg>
                                    <span>Bank Soal</span>
                        ...
                        <li class="menu single-menu <?php echo $this->uri->segment(2) == 'laporan' ? 'active' : '' ?>">
