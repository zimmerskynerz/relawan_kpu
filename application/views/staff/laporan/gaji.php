                                ...
                                <tbody>
                                    ...
                                    foreach ($data_calon_relawan as $Data_calon_relawan) : ?>
                                        <tr>
                                            ...
                                            <td><?= date('d F Y', strtotime($Data_calon_relawan->tgl_gaji)) ?></td>
                                            <td>Rp <?= $Data_calon_relawan->jml_gaji ?>,-</td>
                                        </tr>
                                    <?php
                                        $no++;
                                    endforeach; ?>
    ...
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open_multipart('staff/laporan/gaji_relawan'); ?>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-warning" id="reset_laporan_gaji" name="reset_laporan_gaji"> Reset</button>
                <button type="submit" class="btn btn-primary" id="lihat_laporan_gaji" name="lihat_laporan_gaji"> Lihat</button>
